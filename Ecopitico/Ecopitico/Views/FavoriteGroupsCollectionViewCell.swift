...
class FavoriteGroupsCollectionViewCell: UICollectionViewCell {

    static let identifier = "favoritosCell"
    
    let imageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "aguinha")
...
struct DescansarCollectionViewCell_Preview: PreviewProvider {
    static var previews: some View {
        ...
        Group {
            FavoriteGroupsCollectionViewCell().showPreview().previewLayout(.fixed(width: 157.0, height: 136.0))
